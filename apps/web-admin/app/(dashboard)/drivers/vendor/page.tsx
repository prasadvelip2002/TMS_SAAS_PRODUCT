  ...
  return (
    <div className="max-w-[1600px] mx-auto pb-10">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Vendor Fleet Drivers</h1>
          <p className="text-sm font-medium text-slate-500 mt-1">Manage external 3PL and broker driver profiles and licenses.</p>
        </div>
        <button 
