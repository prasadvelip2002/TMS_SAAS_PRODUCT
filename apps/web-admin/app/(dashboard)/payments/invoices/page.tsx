  ...
  return (
    <div className="relative min-h-full flex flex-col space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2 shrink-0">
        <div>
          <h1 className="font-disp font-bold text-2xl sm:text-[28px] text-slate-900 tracking-tight leading-tight">Customer Invoices</h1>
          <p className="text-xs sm:text-[14px] text-slate-500 mt-1 font-medium">Generate formal tax invoices for closed trips and track payments.</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
          <button 
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-xs sm:text-[13px] font-bold transition-all shadow-sm shadow-blue-600/20 flex items-center justify-center gap-2 w-full sm:w-auto shrink-0"
          >
      ...
      <div 
        className={`fixed top-0 right-0 h-full w-full sm:w-[580px] md:w-[650px] max-w-full bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-l border-slate-200 ${isPanelOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
