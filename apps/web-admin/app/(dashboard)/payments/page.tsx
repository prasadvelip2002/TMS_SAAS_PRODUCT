  ...
  return (
    <div className="relative min-h-full flex flex-col space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2 shrink-0">
        <div>
          <h1 className="font-disp font-bold text-2xl sm:text-[28px] text-slate-900 tracking-tight leading-tight">Payment Ledger</h1>
          <p className="text-xs sm:text-[14px] text-slate-500 mt-1 font-medium">Complete transaction history and manual payment logging.</p>
        </div>
        
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
          <button 
            onClick={() => setIsPanelOpen(true)}
            className="bg-slate-900 hover:bg-slate-800 text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-xs sm:text-[13px] font-bold transition-all shadow-sm flex items-center justify-center gap-2 w-full sm:w-auto shrink-0"
          >
          ...
          <div className="relative flex items-center flex-1 sm:flex-initial">
            ...
            <input 
              ...
              className="w-full sm:w-[240px] h-[40px] sm:h-[42px] bg-white border border-slate-200 rounded-[12px] pl-[40px] pr-[32px] text-xs sm:text-[14px] outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all shadow-sm"
            />
            {searchQuery && (
              <button
