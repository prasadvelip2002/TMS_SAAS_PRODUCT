  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2 shrink-0">
        <div>
          <h1 className="font-disp font-bold text-2xl sm:text-[28px] text-slate-900 tracking-tight leading-tight">POD Management</h1>
          <p className="text-xs sm:text-[14px] text-slate-500 mt-1 font-medium">Review and approve Proof of Delivery documents uploaded by drivers.</p>
        </div>
      ...
      {/* REVIEW POD PANEL */}
      <div 
        className={`fixed top-0 right-0 h-full w-full sm:w-[550px] md:w-[600px] max-w-full bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-l border-slate-200 ${isVerifyPanelOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
