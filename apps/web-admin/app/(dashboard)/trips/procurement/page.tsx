  ...
  return (
    <div className="relative min-h-full flex flex-col space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2 shrink-0">
        <div>
          <h1 className="font-disp font-bold text-2xl sm:text-[28px] text-slate-900 tracking-tight leading-tight">Procurement & Bidding</h1>
          <p className="text-xs sm:text-[14px] text-slate-500 mt-1 font-medium">Manage vendor RFQs, compare bids, and generate POs.</p>
        </div>
      ...
      {/* RFQ BROADCAST PANEL */}
      <div 
        className={`fixed top-0 right-0 h-full w-full sm:w-[480px] max-w-full bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-l border-slate-200 ${isRfqPanelOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
      ...
      {/* VIEW BIDS PANEL */}
      <div 
        className={`fixed top-0 right-0 h-full w-full sm:w-[480px] max-w-full bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-l border-slate-200 ${isBidsPanelOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
        <div className="px-4 sm:px-8 py-4 sm:py-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div>
