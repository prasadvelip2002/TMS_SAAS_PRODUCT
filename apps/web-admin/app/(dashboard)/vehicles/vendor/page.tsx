  ...
  return (
    <div className="max-w-[1600px] mx-auto pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Vendor Fleet Vehicles</h1>
          <p className="text-xs sm:text-sm font-medium text-slate-500 mt-1">Manage external 3PL and broker fleet capacity.</p>
        </div>
        <button 
      ...
      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-slate-200/50 p-2 mb-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <div className="flex items-center px-3 sm:px-4 gap-3 flex-1 min-w-0">
          ...
          <input 
            type="text" 
            placeholder="Search vendor vehicles by reg number, code, type, vendor..." 
            value={searchQuery}
