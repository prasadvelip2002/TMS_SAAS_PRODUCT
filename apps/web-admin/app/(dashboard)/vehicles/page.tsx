  ...
  return (
    <div className="max-w-[1600px] mx-auto pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Vehicle Management</h1>
          <p className="text-xs sm:text-sm font-medium text-slate-500 mt-1">Manage fleet inventory, capacity, and compliance documents.</p>
        </div>
        <button 
